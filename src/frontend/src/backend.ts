...
import type { Inquiry as _Inquiry, InquiryInput as _InquiryInput, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async markInquiryResolved(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markInquiryResolved(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeCategory(arg0: Category): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitInquiry(arg0: InquiryInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(to_candid_InquiryInput_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        productId: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.productId)),
        email: value.email,
...
function to_candid_InquiryInput_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InquiryInput): _InquiryInput {
